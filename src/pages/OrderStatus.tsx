...
const PO1041161391_SAP_BY_SUPPLIER: Record<string, string> = {
  대웅제약: [
    'OTC(제): 오더(1510223871) / 납품(8012986009) (공장) (출하)',
    'OTC(제): 오더(1510223871) / 납품(8013000947) (지역) (출하)',
  ].join('\n'),
  대웅바이오: [
    'ETC(바): 오더(1510223889) / 납품(8012996999) (지역)',
    'ETC(바): 오더(1510223870) / 납품(8012986191) (지역)',
    'ETC(바): 오더(1510223872) / 납품(8012986123) (지역)',
  ].join('\n'),
}
...
const DUAL_SUPPLIER_SAP_BY_SUPPLIER: Record<string, string> = {
  대웅제약:
    'OTC(제): 오더(1710333001) / 납품(8014001001) (공장)',
  대웅바이오:
    'ETC(바): 오더(1710333002) / 납품(8014002002) (지역)',
}
